...
const Contact = () => {
    return (
        <div>
            <Helmet>
        <title>Sunshine City Contact</title>
              ...
              <ul className="mb-6 md:mb-0">
                <li className="flex">
                  ...
                  <div className="ml-4 mb-4">
                    ...
                    <p className="text-gray-600 dark:text-slate-400">1230 BARI Joydebpur</p>
                ...
                <li className="flex">
                  ...
                  <div className="ml-4 mb-4">
                    ...
                    <p className="text-gray-600 dark:text-slate-400">Mobile: 01876523323</p>
                    <p className="text-gray-600 dark:text-slate-400">Mail: sunshinecity@gmail.com</p>
                  </div>
                </li>
                <li className="flex">
                  <div className="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                  ...
                  <div className="ml-4 mb-4">
                    <h3 className="mb-2 text-lg font-medium leading-6 text-gray-900 dark:text-white">Working
                      hours</h3>
                    <p className="text-gray-600 dark:text-slate-400">Monday - Friday: 08:00 - 12:00</p>
                    <p className="text-gray-600 dark:text-slate-400">Saturday : 08:00 - 10:00</p>
