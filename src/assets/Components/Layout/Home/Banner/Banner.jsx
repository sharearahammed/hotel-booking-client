    ...
    <div className="bg-white rounded-none">
      ...
      >
        ...
        >  
          ...
          <div className="space-y-7 pl-8 flex flex-col text-left">
            <h1 className="animate__animated animate__fadeInDown mb-4 text-xl md:text-2xl lg:text-4xl text-white font-bold">
              Welcome to Sunshine City <span className="lg:text-5xl font-bold bg-gradient-to-r from-[#0062c4] to-[#FF4500]  bg-clip-text text-transparent">Hotel</span> – <br/> Where Every Stay Shines Bright!
            </h1>
        ...
        >
          ...
          <div className="space-y-7 pl-8 flex flex-col text-left">
            <h1 className="animate__animated animate__fadeInDown mb-4 text-xl md:text-2xl lg:text-4xl text-white font-bold">
              Welcome to Sunshine City <span className="lg:text-5xl font-bold bg-gradient-to-r from-blue-400 to-[#FF4500]  bg-clip-text text-transparent">Hotel</span> – <br/> Where Every Stay Shines Bright!
            </h1>
            <p className="mb-3 text-white text-[12px] lg:text-[18px] lg:p-0">
              Experience luxury and comfort at Sunshine City Hotel. Immerse yourself in modern elegance and exceptional service during your stay
            </p>
